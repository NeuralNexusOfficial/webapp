...
VISION:
AOT Hackathon aims to create a platform where technology, creativity, innovation, and storytelling intersect to build the future. The event identifies talented individuals and teams capable of solving modern challenges through impactful ideas and scalable execution. This is not just a competition — it is an ecosystem designed to transform ideas into real-world products, careers, games, films, and startups.

---

CONTACT:
support@neuralnexus.dev
...
A: A working prototype, GitHub repository link, and a short demo video. Storytelling domain requires original stories/screenplays.
